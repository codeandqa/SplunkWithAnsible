...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "acs" do |acs|
    ...
    acs.vm.hostname = "acs"
    acs.vm.network "private_network", ip: "192.168.10.33"
  ...
  config.vm.define "splunk" do |splunk|
    ...
    splunk.vm.network "private_network", ip: "192.168.10.35"
  ...
  config.vm.define "django" do |django|
    ...
    django.vm.network "private_network", ip: "192.168.10.34"
    ...
    django.vm.provision "shell", inline: "python -m SimpleHTTPServer 8080"
  end
end
